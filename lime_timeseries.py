...
class LimeTimeSeriesExplainer(object):
    ...
    def explain_instance(self,
                         ...
                         classifier_fn,
                         num_slices,
                         labels=None,  #original version(1):labels=(1,)
                         top_labels=4, #original version(2):top_labels=None #advice: set top_labels = cluster_n
                         num_features=10,
                         num_samples=5000,
    ...
    def __data_labels_distances(cls,
        ...
        #original version(3): predictions = classifier_fn(np.array(original_data))
        predictions = []
        for sub_data in original_data:
            prediction = classifier_fn(np.array(sub_data))
